...
export function KokiSidebar({ open = false, onClose }: { open?: boolean; onClose?: () => void }) {
  ...
  const content = (
    <>
      {/* Logo */}
      <Link href="/dashboard/koki" onClick={onClose} className="px-5 pt-7 pb-5 block hover:opacity-80 transition-opacity">
        ...
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-[360px] mx-4 rounded-2xl border border-white/10 bg-[#1E2235] p-8 flex flex-col items-center text-center space-y-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-400 text-sm">Anda akan keluar dari sesi koki ini.</p>
            </div>
