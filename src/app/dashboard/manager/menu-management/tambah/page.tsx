...
export default function TambahMenuPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    setError(null);
    try {
      const [kategori, bahan] = await Promise.all([api.getKategori(), api.getBahanBaku()]);
      setKategoriList(kategori.filter((k) => k.aktif));
      setBahanList(bahan);
    } catch (e) {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {loading ? (
        <div className="text-center py-12 text-sm" style={{ color: "#64748b" }}>Memuat data...</div>
      ) : (
            ...
            >
              ...
              <div className="text-center px-4">
                ...
                <p className="text-xs mt-2 leading-relaxed" style={{ color: "#64748b" }}>
                  Maksimal file 2MB (JPG, PNG, WebP).
                </p>
              </div>
            </label>

            <div>
              <label className="block text-xs font-semibold mb-2" style={{ color: "#94a3b8" }}>atau Path Gambar (opsional)</label>
              <input
                type="text"
              ...
              <div className="rounded-xl border overflow-hidden" style={{ borderColor: "#494454" }}>
                <div className="relative w-full" style={{ height: 200, backgroundColor: "#080F17" }}>
                  {(preview ?? form.gambar) ? (
                    ...
                    <img src={preview ?? form.gambar} alt="Preview" className="w-full h-full object-cover" />
                  ) : (
        ...
        >
          ...
          >
            ...
            <div className="space-y-2">
              <h3 className="text-white font-bold text-lg leading-snug">Apakah Anda Yakin Menyimpan Menu Ini?</h3>
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ backgroundColor: "rgba(0,0,0,0.6)" }}>
          ...
          >
            ...
            <div className="space-y-2">
              <h3 className="text-white font-bold text-lg leading-snug">Menu Berhasil Ditambahkan!</h3>
              <p className="text-sm leading-relaxed" style={{ color: "#94a3b8" }}>
